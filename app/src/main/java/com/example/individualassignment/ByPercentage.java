...
public class ByPercentage extends AppCompatActivity {
    ...
    private static final String TAG = "ByPercentage"; // Define a tag for logging
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnCalculate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!proceedClicked) {
                    Toast.makeText(ByPercentage.this, "Please click the Proceed button first.", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        btnClear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                // Clear the calculation, hide the result, and show the "Proceed" button again
                clearCalculation();
            }
        });
    ...
    private void showPercentageList() {
        Log.d(TAG, "showPercentageList: Displaying percentage list");
        ...
        // Remove the previous views before displaying the percentage list
        llContainer.removeAllViews();

        // Add dynamically generated EditText fields for percentages
    ...
    private void calculateBreakdown() {
        ...
        List<Double> percentages = new ArrayList<>();   //list of percentages
        List<String> names = new ArrayList<>();     //list of names
        double totalPercentage = 0;

        // Get the percentage values entered by the user and calculate the total percentage
        for (int i = 0; i < numberOfPeople; i++) {
            LinearLayout personLayout = (LinearLayout) llContainer.getChildAt(i);
            // EditText for name
            EditText etName = (EditText) personLayout.getChildAt(0);
            String name = etName.getText().toString();

            // EditText for percentage
            EditText etPercentage = (EditText) personLayout.getChildAt(1);
            String percentageString = etPercentage.getText().toString();
        ...
        // Calculate individual breakdown amounts based on percentages
        double totalBill = Double.parseDouble(etTotalBill.getText().toString());
        StringBuilder breakdownResult = new StringBuilder();
        breakdownResult.append("Breakdown by Percentage:\n");

        for (int i = 0; i < numberOfPeople; i++) {
            double individualAmount = (percentages.get(i) / 100) * totalBill;
